...
const S = {
  page:     { padding: 'clamp(14px,4vw,24px)', maxWidth: 1100 } as React.CSSProperties,
...
export default function DashboardHome() {
  ...
  return (
    <div style={S.page}>
      <style>{`@keyframes spin { to { transform:rotate(360deg) } } @media(max-width:480px){.dash-header{flex-direction:column!important;align-items:flex-start!important;}.dash-period{margin-top:8px;}}`}</style>

      {}
      <div className="dash-header" style={{ marginBottom: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap' as const, gap: 10 }}>
        <div>
