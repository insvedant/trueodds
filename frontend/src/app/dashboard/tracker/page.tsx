    ...
    <div style={{ padding: 'clamp(14px,4vw,24px)' }}>
      <style>{`
        ...
        @media (max-width: 768px) {
          /* Stats grid 2 cols */
          .tracker-stats { grid-template-columns: 1fr 1fr !important; gap: 8px !important; }
          /* Chart full width */
          .tracker-chart { padding: 12px !important; }
          /* Add bet form */
          .tracker-form-3col { grid-template-columns: 1fr !important; }
          .tracker-form-4col { grid-template-columns: 1fr 1fr !important; }
          /* Table → hide header, show card rows */
          .tracker-table-header { display: none !important; }
          .tracker-table-row {
            grid-template-columns: 1fr !important;
            padding: 12px 14px !important;
            gap: 4px !important;
          }
          .tracker-row-game { font-size: 14px !important; font-weight: 700 !important; grid-column: 1 !important; }
          .tracker-row-meta { font-size: 11px !important; color: var(--muted) !important; grid-column: 1 !important; }
          .tracker-row-result { grid-column: 1 !important; }
          .tracker-row-profit { font-size: 16px !important; font-weight: 900 !important; grid-column: 1 !important; }
          .tracker-row-delete { position: absolute !important; top: 10px !important; right: 10px !important; }
          /* Better: use flex for tracker rows */
          .tracker-table-row {
          ...
          .tracker-table-row > * { flex-shrink: 0 !important; }
          .tracker-game-cell { flex: 1 !important; min-width: 150px !important; }
          /* Sport filters wrap */
          .tracker-filters { flex-wrap: wrap !important; gap: 6px !important; }
        }
      `}</style>
      <Celebrations />
