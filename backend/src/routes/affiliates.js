...
const DEFAULT_BOOKS = [
  { sportsbook_id:'draftkings',  displayName:'DraftKings',  baseUrl:'https://sportsbook.draftkings.com', affiliateUrl:'https://sportsbook.draftkings.com', logoColor:'#53d337', markets:['US','CA'] },
  { sportsbook_id:'fanduel',     displayName:'FanDuel',     baseUrl:'https://sportsbook.fanduel.com',   affiliateUrl:'https://sportsbook.fanduel.com',   logoColor:'#1493ff', markets:['US','CA'] },
  { sportsbook_id:'betmgm',      displayName:'BetMGM',      baseUrl:'https://sports.betmgm.com',        affiliateUrl:'https://sports.betmgm.com',        logoColor:'#d4af37', markets:['US','CA'] },
  { sportsbook_id:'caesars',     displayName:'Caesars',     baseUrl:'https://sportsbook.caesars.com',   affiliateUrl:'https://sportsbook.caesars.com',   logoColor:'#0047ab', markets:['US','CA'] },
  ...
  { sportsbook_id:'pointsbet',   displayName:'PointsBet',   baseUrl:'https://pointsbet.com',            affiliateUrl:'https://pointsbet.com',            logoColor:'#ff6600', markets:['US','CA'] },
  ...
  { sportsbook_id:'bet365',      displayName:'Bet365',      baseUrl:'https://www.bet365.com',           affiliateUrl:'https://www.bet365.com',           logoColor:'#028a0f', markets:['CA'] },
  { sportsbook_id:'williamhill', displayName:'William Hill',baseUrl:'https://www.williamhill.com',      affiliateUrl:'https://www.williamhill.com',      logoColor:'#7b1fa2', markets:['US','CA'] },
  ...
  { sportsbook_id:'unibet',      displayName:'Unibet',      baseUrl:'https://www.unibet.com',           affiliateUrl:'https://www.unibet.com',           logoColor:'#147b45', markets:['US','CA'] },
...
async function seedDefaults() {
  try {
    const count = await AffiliateLink.countDocuments()
    if (count === 0) {
      await AffiliateLink.insertMany(DEFAULT_BOOKS)
      console.log('[Affiliates] Seeded', DEFAULT_BOOKS.length, 'default sportsbooks')
    }
  } catch (err) {
